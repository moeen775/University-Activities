...
public class IUBGroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iubgroup);
        ...
        webView = new WebView(IUBGroup.this);
        ...
        webView.setWebViewClient(new IUBGroup.HelloWebViewClient());
        webView.setWebChromeClient(new IUBGroup.ChromeClient());
        ...
        if(!isNetworkAvailable(IUBGroup.this)){
