...
public class cgpaCalculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = new WebView(cgpaCalculator.this);
        ...
        webView.setWebViewClient(new cgpaCalculator.HelloWebViewClient());
        webView.setWebChromeClient(new cgpaCalculator.ChromeClient());
        webView.getSettings().setDomStorageEnabled(true);

        webView.loadUrl("https://shouravbr.github.io/iub-cgpa-calculator/");
        ...
        if(!isNetworkAvailable(cgpaCalculator.this)){
