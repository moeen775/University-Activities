...
public class iras extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebViewClient(new iras.HelloWebViewClient());
        webView.setWebChromeClient(new iras.ChromeClient());
        webView.getSettings().setDomStorageEnabled(true);

        webView.loadUrl("https://iras.iub.edu.bd/login/Default.aspx");
        ...
        if(!isNetworkAvailable(iras.this)){
